...
public class Inventory : MonoBehaviour
{
    ...
    // ========= Diferen�a vinda do segundo c�digo =========
    ...
    void Update()
    {
        // Verifica se a tecla F foi pressionada e se um slot est� selecionado
        if (Input.GetKeyDown(KeyCode.F) && selectedSlot != null)
        {
            // ================= AVISO IMPORTANTE =================
            // Substitua "PhotoAlbum" abaixo pelo nome exato do item que representa o di�rio.
            // ======================================================
